...
proc orxConsole_Setup*() {.cdecl, importc: "orxConsole_Setup", dynlib: "liborxd.so".}
...
proc orxConsole_Exit*() {.cdecl, importc: "orxConsole_Exit", dynlib: "liborxd.so".}
...
proc orxConsole_SetToggle*(eInputType: orxINPUT_TYPE; eInputID: orxENUM;
    ...
    importc: "orxConsole_SetToggle", dynlib: "liborxd.so".}
## * Logs to the console
...
proc orxConsole_Log*(zText: cstring): orxSTATUS {.cdecl,
    importc: "orxConsole_Log", dynlib: "liborxd.so".}
...
proc orxConsole_SetFont*(pstFont: ptr orxFONT): orxSTATUS {.cdecl,
    importc: "orxConsole_SetFont", dynlib: "liborxd.so".}
...
proc orxConsole_GetCompletionCount*(pu32MaxLength: ptr orxU32): orxU32 {.cdecl,
    importc: "orxConsole_GetCompletionCount", dynlib: "liborxd.so".}
## * Gets completion
...
proc orxConsole_GetCompletion*(u32Index: orxU32; pbActive: ptr orxBOOL): cstring {.
    cdecl, importc: "orxConsole_GetCompletion", dynlib: "liborxd.so".}
...
proc orxConsole_GetInput*(pu32CursorIndex: ptr orxU32): cstring {.cdecl,
    importc: "orxConsole_GetInput", dynlib: "liborxd.so".}
## * @}
