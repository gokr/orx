...
typedef enum __orxJOYSTICK_AXIS_t
{
  ...
  orxJOYSTICK_AXIS_LX_3,
  orxJOYSTICK_AXIS_LY_3,
  orxJOYSTICK_AXIS_RX_3,
  orxJOYSTICK_AXIS_RY_3,
  orxJOYSTICK_AXIS_LTRIGGER_3,
  orxJOYSTICK_AXIS_RTRIGGER_3,
  orxJOYSTICK_AXIS_LX_4,
  orxJOYSTICK_AXIS_LY_4,
  orxJOYSTICK_AXIS_RX_4,
  orxJOYSTICK_AXIS_RY_4,
  orxJOYSTICK_AXIS_LTRIGGER_4,
  orxJOYSTICK_AXIS_RTRIGGER_4,
  orxJOYSTICK_AXIS_LX_5,
  orxJOYSTICK_AXIS_LY_5,
  orxJOYSTICK_AXIS_RX_5,
  orxJOYSTICK_AXIS_RY_5,
  orxJOYSTICK_AXIS_LTRIGGER_5,
  orxJOYSTICK_AXIS_RTRIGGER_5,
  /* TODO orxJOYSTICK_DECLARE_AXIS_ENUM(6),
