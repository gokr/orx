...
proc orxProfiler_Setup*() {.cdecl, importcpp: "orxProfiler_Setup(@)",
                          dynlib: "liborx.so".}
## * Inits the Profiler module
##  @return orxSTATUS_SUCCESS / orxSTATUS_FAILURE
##

proc orxProfiler_Init*(): orxSTATUS {.cdecl, importcpp: "orxProfiler_Init(@)",
                                   dynlib: "liborx.so".}
## * Exits from the Profiler module

proc orxProfiler_Exit*() {.cdecl, importcpp: "orxProfiler_Exit(@)",
                         dynlib: "liborx.so".}
...
proc orxProfiler_GetIDFromName*(zName: ptr orxCHAR): orxS32 {.cdecl,
    importcpp: "orxProfiler_GetIDFromName(@)", dynlib: "liborx.so".}
...
proc orxProfiler_IsMarkerIDValid*(s32MarkerID: orxS32): orxBOOL {.cdecl,
    importcpp: "orxProfiler_IsMarkerIDValid(@)", dynlib: "liborx.so".}
...
proc orxProfiler_PushMarker*(s32MarkerID: orxS32) {.cdecl,
    importcpp: "orxProfiler_PushMarker(@)", dynlib: "liborx.so".}
## * Pops a marker (from the stack) and updates its cumulated time (using the last marker push time)
##

proc orxProfiler_PopMarker*() {.cdecl, importcpp: "orxProfiler_PopMarker(@)",
                              dynlib: "liborx.so".}
...
proc orxProfiler_EnableMarkerOperations*(bEnable: orxBOOL) {.cdecl,
    importcpp: "orxProfiler_EnableMarkerOperations(@)", dynlib: "liborx.so".}
## * Are marker push/pop operations enabled?
##  @return orxTRUE / orxFALSE
##

proc orxProfiler_AreMarkerOperationsEnabled*(): orxBOOL {.cdecl,
    importcpp: "orxProfiler_AreMarkerOperationsEnabled(@)", dynlib: "liborx.so".}
## * Pauses/unpauses the profiler
##  @param[in] _bPause           Pause
##

proc orxProfiler_Pause*(bPause: orxBOOL) {.cdecl, importcpp: "orxProfiler_Pause(@)",
                                        dynlib: "liborx.so".}
## * Is profiler paused?
##  @return orxTRUE / orxFALSE
##

proc orxProfiler_IsPaused*(): orxBOOL {.cdecl, importcpp: "orxProfiler_IsPaused(@)",
                                     dynlib: "liborx.so".}
## * Resets all markers (usually called at the end of the frame)
##

proc orxProfiler_ResetAllMarkers*() {.cdecl, importcpp: "orxProfiler_ResetAllMarkers(@)",
                                    dynlib: "liborx.so".}
## * Resets all maxima (usually called at a regular interval)
##

proc orxProfiler_ResetAllMaxima*() {.cdecl,
                                   importcpp: "orxProfiler_ResetAllMaxima(@)",
                                   dynlib: "liborx.so".}
...
proc orxProfiler_GetMarkerCount*(): orxS32 {.cdecl,
    importcpp: "orxProfiler_GetMarkerCount(@)", dynlib: "liborx.so".}
...
proc orxProfiler_GetNextMarkerID*(s32MarkerID: orxS32): orxS32 {.cdecl,
    importcpp: "orxProfiler_GetNextMarkerID(@)", dynlib: "liborx.so".}
...
proc orxProfiler_GetNextSortedMarkerID*(s32MarkerID: orxS32): orxS32 {.cdecl,
    importcpp: "orxProfiler_GetNextSortedMarkerID(@)", dynlib: "liborx.so".}
...
proc orxProfiler_SelectQueryFrame*(u32QueryFrame: orxU32; u32ThreadID: orxU32): orxSTATUS {.
    cdecl, importcpp: "orxProfiler_SelectQueryFrame(@)", dynlib: "liborx.so".}
...
proc orxProfiler_GetMarkerTime*(s32MarkerID: orxS32): orxDOUBLE {.cdecl,
    importcpp: "orxProfiler_GetMarkerTime(@)", dynlib: "liborx.so".}
...
proc orxProfiler_GetMarkerMaxTime*(s32MarkerID: orxS32): orxDOUBLE {.cdecl,
    importcpp: "orxProfiler_GetMarkerMaxTime(@)", dynlib: "liborx.so".}
...
proc orxProfiler_GetMarkerName*(s32MarkerID: orxS32): ptr orxCHAR {.cdecl,
    importcpp: "orxProfiler_GetMarkerName(@)", dynlib: "liborx.so".}
...
proc orxProfiler_GetMarkerPushCount*(s32MarkerID: orxS32): orxU32 {.cdecl,
    importcpp: "orxProfiler_GetMarkerPushCount(@)", dynlib: "liborx.so".}
...
proc orxProfiler_IsUniqueMarker*(s32MarkerID: orxS32): orxBOOL {.cdecl,
    importcpp: "orxProfiler_IsUniqueMarker(@)", dynlib: "liborx.so".}
...
proc orxProfiler_GetUniqueMarkerStartTime*(s32MarkerID: orxS32): orxDOUBLE {.cdecl,
    importcpp: "orxProfiler_GetUniqueMarkerStartTime(@)", dynlib: "liborx.so".}
...
proc orxProfiler_GetUniqueMarkerDepth*(s32MarkerID: orxS32): orxU32 {.cdecl,
    importcpp: "orxProfiler_GetUniqueMarkerDepth(@)", dynlib: "liborx.so".}
## * @}
