...
import
  base/orxType, base/orxModule, plugin/define/orxPlugin_CoreID
...
proc orxPlugin_AddCoreInfo*(ePluginCoreID: orxPLUGIN_CORE_ID;
    ...
    importcpp: "orxPlugin_AddCoreInfo(@)", dynlib: "liborx.so".}
when defined(EMBEDDED):
  ...
  proc orxPlugin_BindCoreInfo*(ePluginCoreID: orxPLUGIN_CORE_ID;
      ...
      importcpp: "orxPlugin_BindCoreInfo(@)", dynlib: "liborx.so".}
...
proc orxPlugin_DefaultCoreFunction*(zFunctionName: ptr orxCHAR;
    ...
    cdecl, importcpp: "orxPlugin_DefaultCoreFunction(@)", dynlib: "liborx.so".}
## * @}
