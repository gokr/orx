...
proc orxBank_Setup*() {.cdecl, importc: "orxBank_Setup", dynlib: "liborxd.so".}
## * Inits the bank Module
##  @return orxSTATUS_SUCCESS / orxSTATUS_FAILURE
##

proc orxBank_Init*(): orxSTATUS {.cdecl, importc: "orxBank_Init", dynlib: "liborxd.so".}
## * Exits from the bank module
##

proc orxBank_Exit*() {.cdecl, importc: "orxBank_Exit", dynlib: "liborxd.so".}
...
proc orxBank_Create*(u16NbElem: orxU16; u32Size: orxU32; u32Flags: orxU32;
    ...
    importc: "orxBank_Create", dynlib: "liborxd.so".}
...
proc orxBank_Allocate*(pstBank: ptr orxBANK): pointer {.cdecl,
    importc: "orxBank_Allocate", dynlib: "liborxd.so".}
...
proc orxBank_AllocateIndexed*(pstBank: ptr orxBANK; pu32ItemIndex: ptr orxU32;
    ...
    importc: "orxBank_AllocateIndexed", dynlib: "liborxd.so".}
...
proc orxBank_Free*(pstBank: ptr orxBANK; pCell: pointer) {.cdecl,
    importc: "orxBank_Free", dynlib: "liborxd.so".}
...
proc orxBank_GetNext*(pstBank: ptr orxBANK; pCell: pointer): pointer {.cdecl,
    importc: "orxBank_GetNext", dynlib: "liborxd.so".}
...
proc orxBank_GetIndex*(pstBank: ptr orxBANK; pCell: pointer): orxU32 {.cdecl,
    importc: "orxBank_GetIndex", dynlib: "liborxd.so".}
...
proc orxBank_GetAtIndex*(pstBank: ptr orxBANK; u32Index: orxU32): pointer {.cdecl,
    importc: "orxBank_GetAtIndex", dynlib: "liborxd.so".}
...
proc orxBank_GetCount*(pstBank: ptr orxBANK): orxU32 {.cdecl,
    importc: "orxBank_GetCount", dynlib: "liborxd.so".}
## ******************************************************************************
##  DEBUG FUNCTION
## ****************************************************************************
...
when defined(DEBUG):
  ...
  proc orxBank_DebugPrint*(pstBank: ptr orxBANK) {.cdecl,
      importc: "orxBank_DebugPrint", dynlib: "liborxd.so".}
## * @}
